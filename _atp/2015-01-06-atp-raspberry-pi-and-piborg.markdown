...
![Raspberry Pi, PicoBorg Reverse and BattBorg boards](//files.ianrenton.com/sites/atp/20.jpg){: .center}
...
![BattBorg fitted to PicoBorg](//files.ianrenton.com/sites/atp/21.jpg){: .center}

Here's all three boards together:

![Three boards together](//files.ianrenton.com/sites/atp/22.jpg){: .center}
...
![All-Terrain Pi electronics stack connected to KVM and WiFi](//files.ianrenton.com/sites/atp/23.jpg){: .center}

And here's where (for lack of anywhere better) the electronics stack will sit on the vehicle:

![All-Terrain Pi electronics stack located on vehicle](//files.ianrenton.com/sites/atp/24.jpg){: .center}

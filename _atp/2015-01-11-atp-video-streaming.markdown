...
![Raspberry Pi camera powered on](/atp/47.jpg){: .center}
...
![mjpg_streamer display on desktop computer](/atp/48.jpg){: .center}
...
![mjpg_streamer display on smartphone](/atp/49.jpg){: .center}

...
![Codes from day 12 with header, checksum and footer removed](/hardware/raspberry-tank/day-30-codes-before.png){: .center}
...
![Day 30 opcode investigation](/hardware/raspberry-tank/day-30-codes-after.png){: .center}

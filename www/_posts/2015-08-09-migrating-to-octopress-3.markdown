...
I've had to faff with a few links here and there to manage the seven different sites as collections under the same site (so apologies if you find any dead links), but the whole thing should be a lot more manageable!

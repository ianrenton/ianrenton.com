...
{% img center http://files.ianrenton.com/sites/atp/17.jpg %}
...
{% img center http://files.ianrenton.com/sites/atp/18.jpg %}

Here's a bonus shot of the ATP hanging out with the Lego Turtle!

{% img center http://files.ianrenton.com/sites/atp/19.jpg %}
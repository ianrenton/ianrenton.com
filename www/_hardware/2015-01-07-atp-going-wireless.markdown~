...
{% img center Original control board http://files.ianrenton.com/sites/atp/25.jpg %}
...
{% img center Original control board with snipped cables http://files.ianrenton.com/sites/atp/26.jpg %}

{% img center Trailing wires http://files.ianrenton.com/sites/atp/27.jpg %}
...
{% img center Electronics stack tied to chassis http://files.ianrenton.com/sites/atp/28.jpg %}
...
{% img center Connections on PicoBorg http://files.ianrenton.com/sites/atp/30.jpg %}
...
{% img center Electronics stack connected to robot http://files.ianrenton.com/sites/atp/31.jpg %}
...
{% img center PicoBorg test GUI in use http://files.ianrenton.com/sites/atp/32.jpg %}

{% img center http://files.ianrenton.com/sites/atp/33.jpg %}
...
{% img center All-Terrain Pi with WiFi dongle fitted http://files.ianrenton.com/sites/atp/35.jpg %}
...
{% img center Attaching the BattBorg to the PicoBorg http://files.ianrenton.com/sites/atp/36.jpg %}

{% img center Attaching the BattBorg to the electronics stack http://files.ianrenton.com/sites/atp/37.jpg %}

This now allows the All-Terrain Pi robot to be powered up without connection to anything else &mdash; it's finally mobile.

{% img center All-Terrain Pi powered up independently http://files.ianrenton.com/sites/atp/38.jpg %}

Now we're free to roam!

{% img center Freely roaming All-Terrain Pi http://files.ianrenton.com/sites/atp/39.jpg %}

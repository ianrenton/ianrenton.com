...
On [day 17](../day-17-whats-missing/), we identified two major issues with the Raspberry Tank's setup -- the Raspberry Pi's inability to power both the WiFi dongle and the camera via its USB ports, and that the "press and hold" web interface causes problems in mobile browsers (its main target).
...
[![Raspberry Tank Schematic (Day 18)](http://files.ianrenton.com/sites/raspberrytank/raspberry-tank-schematic-342x500.png)](http://files.ianrenton.com/sites/raspberrytank/raspberry-tank-schematic-2.png)<br/>
_Raspberry Tank Schematic (Day 18)_

_You can download that as an SVG file here: [Raspberry Tank Schematic (Day 18)](http://files.ianrenton.com/sites/raspberrytank/raspberry-tank-schematic-2.svg)_

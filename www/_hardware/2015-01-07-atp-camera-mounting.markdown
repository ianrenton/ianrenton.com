...
{% img center Raspberry Pi Camera http://files.ianrenton.com/sites/atp/40.jpg %}
...
{% img center Raspberry Pi Camera wit velcro http://files.ianrenton.com/sites/atp/41.jpg %}

The counterpart was stuck to what's now the front section of the robot.

{% img center Velcro mount for camera http://files.ianrenton.com/sites/atp/42.jpg %}

The camera can now be fixed to the front:

{% img center Camera fitted to robot http://files.ianrenton.com/sites/atp/43.jpg %}
...
{% img center All-Terrain Pi with Camera http://files.ianrenton.com/sites/atp/44.jpg %}
...
{% img center Demonstration of Camera working http://files.ianrenton.com/sites/atp/45.jpg %}

...
{% img center //files.ianrenton.com/sites/raspberrytank/airduster.jpg The Raspberry Tank with air duster %}
...
{% img center //files.ianrenton.com/sites/raspberrytank/charging.jpg The new battery charging %}
...
{% img center //files.ianrenton.com/sites/raspberrytank/newbattery.jpg The new battery %}
...
{% img center //files.ianrenton.com/sites/raspberrytank/xt60.jpg New XT60 connectors on the battery, and new wires to put inside the tank. %}
...
{% img center //files.ianrenton.com/sites/raspberrytank/newbatteryinternals.jpg The internals of the tank to support the new battery %}
...
{% img center //files.ianrenton.com/sites/raspberrytank/newbatteryinstalled.jpg The new battery installed in the tank %}
...
{% img center //files.ianrenton.com/sites/raspberrytank/christmas.jpg The Raspberry Tank in front of the Christmas tree %}
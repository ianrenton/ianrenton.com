...
![with the Remote Sensor interface enabled //files.ianrenton.com/sites/atp/50.png](Scratch){: .center}
...
![the All-Terrain Pi from Scratch //files.ianrenton.com/sites/atp/51.png](Controlling){: .center}

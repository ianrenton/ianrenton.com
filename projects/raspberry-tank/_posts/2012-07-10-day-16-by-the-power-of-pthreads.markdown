...
[![Raspberry Tank HTTP Interfaces](/img/projects/raspberry-tank/http_interfaces-600x225.png)](/img/projects/raspberry-tank/http_interfaces.png)
...
The [early control code](/projects/tank-day-10-wireless-enabled/) for the Raspberry Tank relied on keypresses to control the tank's main functions.  Now that we have a web interface, we need to modify the code to make it accept commands from the Web UI.
...
[![Web UI on Tank](/img/projects/raspberry-tank/IMG_20120709_124816-300x225.jpg)](/img/projects/raspberry-tank/IMG_20120709_124816.jpg) [![Close-up of Web UI](/img/projects/raspberry-tank/IMG_20120709_124826-225x300.jpg)](/img/projects/raspberry-tank/IMG_20120709_124826.jpg)

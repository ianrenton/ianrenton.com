...
<p>The information on this page has been preserved for reference. If you would prefer to use the superior AIS-Catcher solution, <a href="/projects/planesailing/ais-receiver">click here.</a></p></div>
...
![Terminal showing AIS NMEA-0183 data](/img/projects/planesailing/ais-nmea.png){: .center .noshadow}
...
![AIS Dispatcher Map](/img/projects/planesailing/ais-dispatcher.png){: .center}
*AIS Dispatcher Map*

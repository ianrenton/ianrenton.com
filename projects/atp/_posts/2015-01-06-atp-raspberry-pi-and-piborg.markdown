...
![Raspberry Pi, PicoBorg Reverse and BattBorg boards](/img/projects/atp/20.jpg){: .center}
...
![BattBorg fitted to PicoBorg](/img/projects/atp/21.jpg){: .center}

Here's all three boards together:

![Three boards together](/img/projects/atp/22.jpg){: .center}
...
![All-Terrain Pi electronics stack connected to KVM and WiFi](/img/projects/atp/23.jpg){: .center}

And here's where (for lack of anywhere better) the electronics stack will sit on the vehicle:

![All-Terrain Pi electronics stack located on vehicle](/img/projects/atp/24.jpg){: .center}
